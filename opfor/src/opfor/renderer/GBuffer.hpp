...
class GBuffer
{
  ...
  public:
    ...
    auto const &GetFramebuffer()
    {
        return _gBuffer;
    }
    auto &GetPositionTex() const
    {
        return _gPosition;
    }
    auto &GetNormalTex() const
    {
        return _gNormal;
    }
    auto &GetAlbedoSpecTex() const
    {
        return _gAlbedoSpec;
    }
    auto &GetDepthTex() const
    {
        return _gDepth;
    }
    auto &GetMetallicRoughnessTex() const
    {
        return _gMetallicRoughness;
    }
};
